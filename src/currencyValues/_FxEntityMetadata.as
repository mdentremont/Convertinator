...
internal class _FxEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal var _currency_codeIsValid:Boolean;
    model_internal var _currency_codeValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _currency_codeIsValidCacheInitialized:Boolean = false;
    model_internal var _currency_codeValidationFailureMessages:Array;
    ...
    public function _FxEntityMetadata(value : _Super_Fx)
    {
        ...
        model_internal::_currency_codeValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForCurrency_code);
        model_internal::_currency_codeValidator.required = true;
        model_internal::_currency_codeValidator.requiredFieldError = "currency_code is required";
        //model_internal::_currency_codeValidator.source = model_internal::_instance;
        //model_internal::_currency_codeValidator.property = "currency_code";
    ...
    public function invalidateDependentOnCurrency_code():void
    {
        if (model_internal::_currency_codeIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfCurrency_code = null;
            model_internal::calculateCurrency_codeIsValid();
        }
    }
    ...
    public function get currency_codeValidator() : StyleValidator
    {
        return model_internal::_currency_codeValidator;
    }

    model_internal function set _currency_codeIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_currency_codeIsValid;         
        if (oldValue !== value)
        {
            model_internal::_currency_codeIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "currency_codeIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get currency_codeIsValid():Boolean
    {
        if (!model_internal::_currency_codeIsValidCacheInitialized)
        {
            model_internal::calculateCurrency_codeIsValid();
        ...
        return model_internal::_currency_codeIsValid;
    }

    model_internal function calculateCurrency_codeIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_currency_codeValidator.validate(model_internal::_instance.currency_code)
        model_internal::_currency_codeIsValid_der = (valRes.results == null);
        model_internal::_currency_codeIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::currency_codeValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::currency_codeValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get currency_codeValidationFailureMessages():Array
    {
        if (model_internal::_currency_codeValidationFailureMessages == null)
            model_internal::calculateCurrency_codeIsValid();

        return _currency_codeValidationFailureMessages;
    }

    model_internal function set currency_codeValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_currency_codeValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_currency_codeValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "currency_codeValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("currency_code"):
            {
                return currency_codeValidationFailureMessages;
            }
            case("rate"):
            {
